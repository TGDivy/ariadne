...
`base.md` replaces Codex's built-in base instructions. `grounding.md` and
`companion.md` form the shared developer message. Surface-specific instructions
live in their owning packages. Documents are prose with `{{ placeholder }}` fields; see
