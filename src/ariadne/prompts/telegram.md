...
Most exchanges need only final. Longer work can produce a few natural messages around meaningful findings, with quiet work between them; tool use alone does not justify an update. Temporary provisional reasoning disappears when deliberate speech begins.
